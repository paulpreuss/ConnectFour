...
public class HardGameBotTests
{
    ...
    public void Setup()
    {
        ...
        _bot = new GameBot(Difficulty.Hard, true);
    }
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeHorizontally_PlacesFourthRight()
    {
        _field = GenerateEmptyField();
        _field[7][0] = 'O';
        _field[7][1] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeHorizontally_PlacesFourthLeft()
    {
        _field = GenerateEmptyField();
        _field[7][5] = 'O';
        _field[7][6] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeHorizontallyLevitating_PlacesFourthRandom()
    {
        _field = GenerateEmptyField();
        _field[6][0] = 'O';
        _field[6][1] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeVertically_PlacesFourthOnTop()
    {
        _field = GenerateEmptyField();
        _field[7][5] = 'O';
        _field[6][5] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeDiagonally_PlacesFourthTopLeft()
    {
        _field = GenerateEmptyField();
        _field[7][7] = 'O';
        _field[6][6] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeDiagonally_PlacesFourthTopRight()
    {
        _field = GenerateEmptyField();
        _field[7][0] = 'O';
        _field[6][1] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeDiagonally_PlacesFourthBottomLeft()
    {
        _field = GenerateEmptyField();
        _field[4][7] = 'O';
        _field[5][6] = 'O';
    ...
    [Test]
    public void CalculateBotPosition_WithEnemyThreeDiagonally_PlacesFourthBottomRight()
    {
        _field = GenerateEmptyField();
        _field[4][0] = 'O';
        _field[5][1] = 'O';
